...
contract EventTicketsV2 {
    ...
    */
    modifier isOwner() {require (msg.sender == owner, "Sender is not the owner!"); _;}
    ...
    */
        ...
        returns(uint)
    {
        ...
        emit LogEventAdded(description, website, totalTickets, newID);
        return newID;
    }    
    ...
    */
    ...
    {   
        Event memory newEvent = events[eventId];
        if (newEvent.totalTickets > 0) {
            return (newEvent.description, newEvent.website, newEvent.totalTickets, newEvent.sales, newEvent.isOpen);
        } else {
            revert ("Event is sold out.");
        }
    }
    ...
    */
        ...
        payable
    {
        ...
        require (newEvent.isOpen == true);
        require (msg.value >= PRICE_TICKET * numTickets);
        require (newEvent.totalTickets - newEvent.sales >= numTickets);

        newEvent.buyers[msg.sender] += numTickets;
        newEvent.sales += numTickets;

        uint refund = msg.value - (PRICE_TICKET * numTickets);
    ...
    */
    ...
    {
        Event storage newEvent = events[eventId];
        uint ticketsPurchased = newEvent.buyers[msg.sender];
        require (ticketsPurchased > 0);

        newEvent.sales -= ticketsPurchased;
        msg.sender.transfer(PRICE_TICKET * ticketsPurchased);
    ...
    */
        ...
        isOwner()
    {
        ...
        uint contractBalance = newEvent.sales * PRICE_TICKET;
